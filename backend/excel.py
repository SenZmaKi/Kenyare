...
from quotation import QuotationInput, QuotationOutput, RateValueOriginal, get_quotation
...
def test_excel():
    ...
    print(output)
    make_excel("FIRST ASSURANCE", "RSI", "FEKAN HOWELL", output, Path("output.xlsx"))
